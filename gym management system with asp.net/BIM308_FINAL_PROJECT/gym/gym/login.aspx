<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="login.aspx.cs" Inherits="gym.Homepage" %>
...
<body>
    ...
    <form id="form1" runat="server" class="frmalg">
        <div class="container">
            ...
            <asp:Button runat="server" ID="btn_register" Text="Register" class="cnbtn"/>
        </div>
    </form>
