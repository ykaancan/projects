<%@ Page Language="C#"AutoEventWireup="true" CodeFile="signIn.aspx.cs" Inherits="gym.signIn" %>
...
<body>
    ...
    <form id="form1" runat="server" class="frmalg">
        <div class="container">
            ...
            <asp:TextBox runat="server" ID="txt_mail" placeholder="Enter Mail"></asp:TextBox>
            ...
            <asp:Button runat="server" ID="btn_register" Text="Register" class="cnbtn" OnClick="btn_register_Click"/>
        </div>
    </form>
    
    <footer style="margin-top:385px">
            <div class="container1 bottom_border" style="bottom: 300px">
            <div class="row">
